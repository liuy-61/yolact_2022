...
def sample_confidence(drop_ratios=None, num_epochs=None, resume=None):
    """
    ...
    confidence_list_path = args.confidence_path
    ...
    for ratio in drop_ratios:
        exp_name = 'train_{}_confidence_threshold_{}_drop{}'.format(cfg.dataset.name, threshold, ratio)
...
if __name__ == '__main__':
    sample_confidence(drop_ratios='0.1,0.2')
