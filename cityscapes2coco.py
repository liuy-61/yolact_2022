...
from data.local import CITY_VAL_IMAGE, CITY_VAL_LABEL, CITY_ROOT, CITY_INSTANCE_VAL_ROOT, \
    CITY_COCO_VAL_LABEL, CITY_TRAIN_IMAGE, CITY_TRAIN_LABEL, CITY_INSTANCE_TRAIN_ROOT, \
    CITY_INSTANCE_TEST_ROOT, CITY_TEST_IMAGE, CITY_TEST_LABEL, CITY_COCO_TEST_IMAGE,\
    CITY_COCO_TEST_GT,CITY_COCO_TRAIN_IMAGE, CITY_COCO_TRAIN_GT, CITY_COCO_VAL_IMAGE, CITY_COCO_VAL_GT
...
def main():
    ...
    turn(image_dir= CITY_COCO_TRAIN_IMAGE,
         annotation_dir= CITY_COCO_TRAIN_GT,
         coco_output=coco_output,
         instance_dir=CITY_INSTANCE_TRAIN_ROOT)
...
if __name__ == "__main__":
    main()
    # with open (os.path.join(CITY_ROOT, 'val.train')) as f:
    #     test_josn = json.load(f)
    #     debug = 0
