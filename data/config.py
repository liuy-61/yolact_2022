...
from data.local import train_image
from data.local import train_info
from data.local import val_image
from data.local import val_info
from data.local import person_train_info
from data.local import  person_val_info
...
#  创建一个coco_person_dataset
coco_person_dataset = dataset_base.copy({
    'name': 'COCO_Person',
    'train_info': person_train_info,
    'valid_info': person_val_info,
    'class_names': COCO_PERSON_CLASSES,
