...
import json
from data.local import tmp_json_root, weight_root, confidence_root
...
def train(exp_name=None, num_epochs=None, dataset=None, resume=None):
    if exp_name is None:
    ...
    try:
        for epoch in range(num_epochs):
            ...
            box_ap, mask_ap = compute_validation_map(epoch, iteration, yolact_net, val_dataset, writer, log if args.log else None)
...
def get_confidnce_v2(threshold=0.5):
    """
